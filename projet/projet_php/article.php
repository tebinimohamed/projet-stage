...
if (isset($_GET['id_user'])) {
    ...
    $query = "INSERT INTO commande (id_user,date_c,id)";
    $query .= "VALUES ($id_user,NOW(),$id)";
                                ...
                                <li class="form-control">
                                    ...
                                    while ($row = mysqli_fetch_assoc($resultat)) {
                                        ...
                                        if ($_SESSION['type']=='Association') {
                                            ...
                                            <a href="article.php?id=<?php echo $_GET['id']; ?>&id_user=<?php echo $_GET['id']; ?>" class="btn btn-success uppercase pull-right">Commander</a>
