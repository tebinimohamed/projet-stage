...
<html lang="en"><!--<![endif]--><!-- BEGIN HEAD --><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo">
        <form action="utilisateur.php" action="post"> 
            <!-- BEGIN HEADER -->
                        ...
                        <div class="page-title">
                            <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-cogs"></i>Table des utilisateur 
                                    </div>
                                    <div class="tools">

                                        <a href="javascript:;" class="collapse" data-original-title="" title=""> </a>
                                        <a href="file:///C:/Users/daly/Desktop/THEME%20admin/metronic_v4.5.6/theme/admin_4/table_static_responsive.html#portlet-config" data-toggle="modal" class="config" data-original-title="" title=""> </a>
                                    ...
                                    <table class="table table-bordered table-striped table-condensed flip-content">
                                        <thead class="flip-content">
                                            <tr>
                                                ...
                                                <th class="numeric"> Date de naissance </th>
                                                <th class="numeric"> Numéro télphone </th>
                                                <th class="numeric"> Sexe </th>
                                            ...
                                            <tr>
                                                ...
                                                while ($row = mysqli_fetch_array($exe)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        for ($j = 1; $j <= $NbrCol; $j++) {
                                                            ?>      
                                                            <td class="numeric"> <?php echo $row['nom']; ?></td>
                                                            <td class="numeric"><?php echo $row['prenom']; ?></td>
                                                            <td class="numeric"><?php echo $row['email']; ?></td>
                                                            <td class="numeric"><?php echo $row['cin']; ?></td>
                                                            <td class="numeric"><?php echo $row['date_naissance']; ?></td>
                                                            <td class="numeric"><?php echo $row['num_tel']; ?></td>
                                                            <td class="numeric"><?php echo $row['sexe']; ?></td>
                                                            <td class="numeric"><?php echo $row['type']; ?></td>
                                                            <td class="numeric"><?php echo $row['username']; ?></td>
                                                            <td class="numeric"><?php echo $row['password']; ?></td>
                                                            <td class="numeric"><?php echo $row['id_user']; ?></td>
                                                            <td class="numeric"><?php echo $row['adresse']; ?></td>
                                                            <td class="numeric"><a href="sup.php?id=<?php echo $row['id_user']; ?>" class="btn green pull-right">supprimer</a></td>
                                                            </td>
        <?php }
        ?>
                                                    </tr>
