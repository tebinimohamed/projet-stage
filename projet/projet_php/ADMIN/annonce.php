                                            ...
                                            <div class="page-title">
                                                <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-cogs"></i>Table des annonce </div>
                                                            <div class="tools">
                                                            ...
                                                            <table class="table table-bordered table-striped table-condensed flip-content">
                                                                <thead class="flip-content">
                                                                    <tr>
                                                                        ...
                                                                        <th class="numeric">Commentaire</th>
                                                                        <th class="numeric">Supprimier</th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                                    <tr>
                                                                            ...
                                                                            for ($i = 1; $i <= $NbrLigne; $i++) {
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    for ($j = 1; $j <= $NbrCol; $j++) {
                                                                                        ...
                                                                                        <td class="numeric"><?php echo $row['datee']; ?></td>
                                                                                        <td class="numeric"><?php echo $row['id']; ?></td>
                                                                                        <td class="numeric"><img src="uploads/<?php echo $row['file']; ?>"></td>
                                                                                        <td class="numeric"> <?php echo $row['commentaire']; ?></td>
                                                                                        <td class="numeric"><a href="sup2.php?id=<?php echo $row['id']; ?>" 
                                                                                         class="btn green pull-right">supprimer</a></td>
                                                                                         <?php }
                                                                                         ?>
                                                                                     </tr>
                                                                                     <?php
