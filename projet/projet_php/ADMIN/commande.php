                                ...
                                <div class="portlet-body flip-scroll">
                                    ...
                                    <table class="table table-bordered table-striped table-condensed flip-content">
                                        <thead class="flip-content">
                                            <tr>
                                                <th class="numeric"> ID Association </th>
                                                <th class="numeric"> ID Annonce </th>
                                                <th class="numeric"> Date </th>
                                                <th class="numeric"> ID Commande </th>

                                                <th class="numeric"> Supprimer </th>                           
                                                <th class="numeric"> Accepter </th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                ...
                                                while ($row = mysqli_fetch_array($exe)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        for ($j = 1; $j <= $NbrCol; $j++) {
                                                            ...
                                                            <td class="numeric"><?php echo $row['date_c']; ?></td>
                                                            <td class="numeric"><?php echo $row['id_comm']; ?></td>
                                                            <td class="numeric"><a href="sup3.php?id=<?php echo $row['id_comm']; ?>" class="btn green pull-right">supprimer</a></td>
                                                            <td class="numeric"><a href="#" class="btn green pull-right">Accepter</a></td>
                                                            </td>
        <?php }
        ?>
                                                    </tr>
