...
if (isset($_POST['btn1'])) {
    ...
    $query = "INSERT INTO annonce (nom,datee,file,commentaire) VALUES ('$nom',NOW(),'$file','$commentaires')";
//die($query);
...
$req1 = mysqli_query($concetion, $sql);
?>
<!DOCTYPE html>
    ...
    <body class="page-container-bg-solid page-md">
        ...
        <div class="page-header">
            <div class="page-header-top">
                <div class="page-logo">
                    <a href="index2.php">
                    <img src="1.png" width="800" height="150">                     </a>
                </div>
                <div class="top-menu">
                    ...
                    <div class="hor-menu  ">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="menu-dropdown classic-menu-dropdown active">
                             ...
                             <li class="menu-dropdown classic-menu-dropdown active">
                            <a href="mailto:annimauxsos@gmail.com">Contact Us</a>  
                               <span class="arrow"></span>
                                </a>
                            </li>
                            <li class="menu-dropdown classic-menu-dropdown active">
                ...
                <div class="page-head">
                    ...
                    <div class="page-content" style="min-height: 308px;">
                        <div class="container">
                            ...
                            for ($i = 1; $i <= $nbPage; $i++) {
                                if ($i == $cPage) {
                                    echo "<ul class=\"pagination\"><li class=\"page-item\"> <a class=\"page-link\" href=\"annonce.php?p=$i\">$i</a> </li></ul>";
                                } else {
                                    echo " <ul class=\"pagination\"><ul class=\"pagination\"><li class=\"page-item\"><a class=\"page-link\" href=\"annonce.php?p=$i\">$i</a></li></ul>";
                                }
                            }
                            ?>
