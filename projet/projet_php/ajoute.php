...
<html lang="en"><!--<![endif]--><!-- BEGIN HEAD --><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <body class=" login">
        ...
        <div class="content">
            ...
            <form class="login-form" action="annonce.php" method="post" enctype="multipart/form-data" novalidate="novalidate">
                <h3 class="form-title font-green">Ajouter une annonce</h3>
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <label class="control-label visible-ie8 visible-ie9">Commentaires</label>
                        <input class="form-control placeholder-no-fix" type="text" placeholder="Commentaires" name="commentaires" required> </div>
                        <div class="form-group">
                            <center>
                                <span class="btn green fileinput-button">
                                    <span> Add files... </span>
                                    <input type="file" name="file" multiple=""> </span></center>
                                    <script src="../assets/global/plugins/jquery.min.js" type="text/javascript"></script></div>

                                    <div class="form-actions">
                                        <button type="button" id="register-back-btn" class="btn green btn-outline"><a href="index2.php"> Back</a> </button>
